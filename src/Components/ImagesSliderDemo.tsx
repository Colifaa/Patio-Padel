  ...
  return (
    <ImagesSlider className="h-screen sm:h-80 md:h-[30rem] lg:h-[40rem] bg-black relative" images={images}>
      ...
      <button
          ...
          className=" z-50 relative inline-flex h-12 active:scale-95 transition-transform overflow-hidden rounded-lg p-[1px] focus:outline-none mt-80"
        >
          <span
            className="z-50 absolute inset-[-1000%] animate-spin bg-[conic-gradient(from_90deg_at_50%_50%,#e7029a_0%,#f472b6_50%,#bd5fff_100%)]"
          ></span>
          <span
            className="z-50 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-6 text-sm font-medium text-white backdrop-blur-3xl gap-2"
          >
            Reservar ahora
            <svg
              stroke="currentColor"
