...
export default function WhyChooseUs() {
  ...
  className="relative inline-flex h-16 active:scale-95 transition-transform overflow-hidden rounded-lg p-[1px] focus:outline-none"
>
  <span
    className="absolute inset-[-1000%] animate-spin bg-[conic-gradient(from_90deg_at_50%_50%,#555555_0%,#666666_50%,#333333_100%)]"
  ></span>
  <span
    className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-[#333333] px-10 text-lg font-medium text-white backdrop-blur-[10px] gap-2"
  >
    Reservar ahora
    <svg
      stroke="currentColor"
